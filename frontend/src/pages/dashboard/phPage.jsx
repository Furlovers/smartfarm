  ...
  return (
    <div className="w-full h-full flex px-8 text-black flex-col">
      <div className="w-full h-60">
        ...
        <CustomLineChart info="ph" filteredSensors={filteredSensors} />
        <div className="w-full h-100 rounded-md mb-2 flex flex-row gap-4">
          <CardsGrid info="ph" filteredSensors={filteredSensors} />
          <div className="bg-white w-1/2 h-104 mt-4 rounded-md">
            <CustomList info="ph" filteredSensors={filteredSensors} />
          </div>
        </div>
      </div>
    </div>
